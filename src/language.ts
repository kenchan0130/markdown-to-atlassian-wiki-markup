...
export type AtlassianSupportLanguage =
  typeof AtlassianSupportLanguage[keyof typeof AtlassianSupportLanguage];
...
export const markdownToWikiMarkupLanguageMapping: Map<string, SupportLanguage> =
  new Map(
